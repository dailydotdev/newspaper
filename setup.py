...
# -*- coding: utf-8 -*-
"""
Lucas Ou-Yang 2014 -- http://format360news.com
"""
...
# https://github.com/news/issues/155
if sys.version_info[0] == 2 and sys.argv[-1] not in ['publish', 'upload']:
    sys.exit('WARNING! You are attempting to install news3k\'s '
             'python3 repository on python2. PLEASE RUN '
             '`$ pip3 install news3k` for python3 or '
             '`$ pip install news` for python2')
...
setup(
    ...
    author_email='elohimministrys@gmail.com',
